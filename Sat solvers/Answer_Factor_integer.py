...
# number stored in z1, z2, z3, ... z_m+n(MSB) :- 1 , 2 , 3 , 4 ... size
...
print("number of variables = ", offset-300+(m+n)+m+n)
...
print("First factor = ", fac1 , " Second factor = ", fac2)