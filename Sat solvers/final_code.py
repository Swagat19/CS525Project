...
if m>= tot_bits or n>= tot_bits or m < 1 or n < 1:
    print("Invalid Input")
    exit()
...
variable_count = offset-300+(m+n)+m+n
...
print("p cnf", variable_count, len(clause))
for cl in clause:
